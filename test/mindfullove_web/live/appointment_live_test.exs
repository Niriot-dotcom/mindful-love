defmodule MindfulloveWeb.AppointmentLiveTest do
  use MindfulloveWeb.ConnCase

  import Phoenix.LiveViewTest
  import Mindfullove.AppointmentsFixtures

  @create_attrs %{status: :CANCELLED, date: "2024-02-21T17:34:00"}
  @update_attrs %{status: :ACTIVE, date: "2024-02-22T17:34:00"}
