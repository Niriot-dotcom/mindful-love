defmodule BmvpWeb.UserLiveTest do
  use BmvpWeb.ConnCase

  import Phoenix.LiveViewTest
  import Bmvp.UsersFixtures

  @create_attrs %{first_name: "some first_name", last_name: "some last_name", phone_number: "some phone_number"}
